...
public class HBaseComTest {
    ...
    final static String HBASETABLE = "custorm";
    final static String HBASECOLUMN = "column";
    ...
    public static void scanTableByPrefixKey(Connection connection, String prefixKey) throws IOException {
        ...
        // FilterList filters = new FilterList(Operator.MUST_PASS_ALL, preFilter, keyFilter);
    ...
    public static void scanTableByFuzzy(Connection connection) throws IOException {
        ...
        // pair中第一个参数为模糊查询的string; 第二个参数为byte[]其中装与string位数相同的数值0或1,0表示该位必须与string中值相同，1表示可以不同
